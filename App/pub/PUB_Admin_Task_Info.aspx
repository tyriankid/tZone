<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PUB_Admin_Task_Info.aspx.cs" Inherits="PUB_Admin_Task_Info" %>
...
<!-- Powered By Hanstrong RIA Visual.NET From No.6 Design With 2015-1-23 11:27:26 -->
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>管理员任务单列表</title>
    ...
    <script type="text/javascript" src="js/PUB_Admin_Task_Info.js"></script>
</head>
<body>
    <form id="form1" runat="server" enableviewstate="false">
   	        
        <div id="label2" style="position:absolute;top:396px;left:5px;width:68px;height:31px;text-align:left;font-size:9pt;background:#FFFFFF;display:block;" dsfield="" ctrltype="label">我的任务</div>    
        <div id="label1" style="position:absolute;top:42px;left:5px;width:80px;height:20px;text-align:left;font-size:9pt;background:#FFFFFF;display:block;" dsfield="" ctrltype="label">所有任务</div>    
    <div id="jq1_pos" style="position:absolute; left:5px; top:57px;">
    ...
    <div id="jq2_pos" style="position:absolute; left:5px; top:414px;">
        ...
        <dx:ASPxButton Enabled="true" Display="block" style="position:absolute;top:5px;left:5px" Width="70px" Height="25px" Text="新建" ID="button1" ClientInstanceName="button1" runat="server" EnableViewState="false" AutoPostBack="false" Image-Url="../../res/icons/add.png" ctrltype="button">
            <ClientSideEvents Click="function(s,e){Add()}"  />
        </dx:ASPxButton>    
        <dx:ASPxButton Enabled="true" Display="block" style="position:absolute;top:5px;left:82px" Width="70px" Height="25px" Text="注销" ID="button2" ClientInstanceName="button2" runat="server" EnableViewState="false" AutoPostBack="false" Image-Url="../../res/icons/(23,39).png" ctrltype="button">
    ...
    <script type="text/javascript">
        <%=SetClientUserInfo()%>
        var CtrlList = [];
        var ds = new dataset({id:'ds',grid:'jq1',data:<%=GetDataSetJson("ds",20,"jq1,详情,编辑,接受任务") %>});ds.Bind2Ctrl();
        var ds2 = new dataset({id:'ds2',grid:'jq2',data:<%=GetDataSetJson("ds2",10,"jq2,详情") %>});ds2.Bind2Ctrl();
        
        var jq1 = $("#jq1_grid").jqGrid($.extend(JqGridFixOptions,{
            <%=GetJqGridColumn("ds","jq1,详情,编辑,接受任务") %>,
            left:5,top:57,height:283,width:'100%',multiselect:false,rownumbers:true,dataset:ds,caption:"",haveFootBar:true,rowNum:20,pager:$("#jq1_pager"),
        ...
        var jq2 = $("#jq2_grid").jqGrid($.extend(JqGridFixOptions,{
            <%=GetJqGridColumn("ds2","jq2,详情") %>,
            left:5,top:414,height:'100%',width:'100%',multiselect:false,rownumbers:true,dataset:ds2,caption:"",haveFootBar:true,rowNum:10,pager:$("#jq2_pager"),
