...
<!-- Powered By Hanstrong RIA Visual.NET From No.4 Design With 2015-1-16 14:52:54 -->
...
<dx:ListEditItem Text="x" Value="0" />        
    ...
    <script type="text/javascript">
        ...
        var jq1 = $("#jq1_grid").jqGrid($.extend(JqGridFixOptions,{
            ...
            onPaging:function(pgb){jq1.PageNav(pgb,Delay());},onSortCol:function(fd,ic,ord){jq1.OrderByCol(fd,ic,ord,'');}
        }));jq1.InitData();
